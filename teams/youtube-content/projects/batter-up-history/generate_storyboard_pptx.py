...
SCENES = {
    ...
    5: {
        ...
        "duration": "20 seconds",
        "image_type": "real",
        "image_files": ["miriam-nunley-top.jpg", "miriam-nunley-ribbon-cutting.jpg"],
        "ai_prompt": "",
        "photo_desc": "(a) miriam-nunley-top: Cropped photo of Miriam Nunley standing by the RUTH organ, Oct 12 1951. Only known identified photo of her. B&W, watermarked PPL. (b) miriam-nunley-ribbon-cutting: Ribbon cutting at carousel opening, Oct 12 1951. Group shot with Miriam Nunley named in caption. B&W.",
        "orientation_note": "Both portrait/tall scans -- use pillarbox",
        "text_overlay": "None",
        "motion": "ken-burns-zoom",
        "audio": "Narration scene-5.wav + bg music 15%",
        "notes": "Real photos from Plainedge Public Library -- contact for reproduction rights before publish",
    },
    6: {
    ...
    15: {
        ...
        "image_files": ["bu9.jpg"],
        "ai_prompt": "",
        "photo_desc": "bu9: Batter Up parking lot and entrance with colorful blue/pink tent structures -- wide shot showing full facility from the street.",
        "orientation_note": "Square (414x414) -- crop to 16:9",
    ...
    20: {
        ...
        "duration": "20 seconds",
        "image_type": "real",
        "image_files": ["bu3.jpg", "bu5.jpg"],
        "ai_prompt": "",
        "photo_desc": "(a) bu3: Batting cages exterior daytime -- chain-link fencing, pitching machines. (b) bu5: Families at batting cages with 'Batter Up Home of...' sign. Closing on the cages -- the survivor.",
        "orientation_note": "Both square (414x414) -- crop to 16:9",
...
def create_summary_slide(prs):
    ...
    lines = [
        ...
        (f"  AI to generate: {ai_count} scenes (1, 5, 15)", False, ORANGE, 13),
        (f"  Multi-image scenes: {multi_image} (Scenes 3, 4, 7, 8, 16, 17, 20)", False, WHITE, 13),
