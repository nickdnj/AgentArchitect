...
description: "Full-stack product development team covering requirements, architecture, UX, development planning, QA, marketing, sales, and legal
  - TRIGGER KEYWORDS: requirements, architecture, ux design, dev planning, qa, marketing, sales, legal, implementation, general, wiki update
  - CAPABILITIES: Product manager, Technical architect, UX designer, Dev lead, QA lead, Marketing strategist, Sales strategist, Legal advisor, Full-stack developer, Promotes architecture decisions, requirements, and release outcomes to the wiki knowledge base"
---
...
### Wiki Ingest
- **Role:** Promotes architecture decisions, requirements, and release outcomes to the wiki knowledge base
...
**Path:** `AgentArchitect/teams/software-project/_sessions/`
