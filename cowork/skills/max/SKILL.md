...
description: "Nick's personal assistant team led by Max. Handles research with persistent caching, email management, document creation, knowledge management, and task tracking.
  - TRIGGER KEYWORDS: garage sales, amazon shopping, web research, browser tasks, document search, pdf work, general
  - CAPABILITIES: Primary personal assistant, Researches and generates garage/yard/estate sale reports for any location with maps and routes, Searches Amazon for products, compares options, and generates affiliate-linked recommendations"
---
