...
description: "Hardware product development team covering schematic/PCB design, mechanical engineering, firmware, supply chain, and manufacturing readiness
  - TRIGGER KEYWORDS: new product, conops, requirements, architecture, interface, integration, trade study, v model, verification, validation, systems engineering, risk, change impact, schematic, pcb, layout, kicad, circuit, enclosure, mechanical, mounting, cad, 3d print, firmware, embedded, esp32, jetson, driver, ota, bom, sourcing, cost, component, manufacturer, dfm, manufacturing, test, compliance, fcc, certification, general, wiki update
  - CAPABILITIES: Systems engineering manager, Schematic and PCB layout engineer, Mechanical design engineer, Firmware engineer, Supply chain manager, DFM & test engineer, Promotes design decisions, test results, and sourcing intel to the wiki knowledge base"
---
...
### Wiki Ingest
- **Role:** Promotes design decisions, test results, and sourcing intel to the wiki knowledge base
...
**Path:** `AgentArchitect/teams/hardware-dev/_sessions/`
