...
After a non-trivial session, append a one-paragraph summary to `~/Workspaces/wiki/teams/software-project/_sessions/dev-planning/YYYY-MM-DD.md`.
...
2. Subject line: `Dev Plan Review: {project} - v0.1`
