...
After a non-trivial session, append a one-paragraph summary to `~/Workspaces/wiki/teams/software-project/_sessions/legal/YYYY-MM-DD.md`.
...
2. Subject line: `Legal Review: {project} - v0.1`
