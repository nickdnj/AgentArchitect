...
|---------|---------|----------|
| **board** (default) | `YOUR_BOARD_EMAIL` | Current board email |
| **personal** | `YOUR_PERSONAL_EMAIL` | Historical board business & prior board tenure |
...
[Searches YOUR_BOARD_EMAIL]
[Searches YOUR_PERSONAL_EMAIL]
...
Agent: I'll search your personal email (YOUR_PERSONAL_EMAIL) for historical
board minutes.
