...
${MCP_SERVERS_PATH}  → /app/templates/   read-only
${MCP_SERVERS_PATH}  → /app/workspace/   read-write
```
...
```bash
cp ${MCP_SERVERS_PATH} ~/Desktop/Output.pptx
```
...
- **Google Drive**: `${GOOGLE_DRIVE_PATH} drives/Board Open Meetings/Presentations/`
...
### Template Not Found
- Verify templates exist: `ls ${MCP_SERVERS_PATH}
