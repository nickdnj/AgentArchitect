...
<!-- collaboration: {"can_request_from":["archivist","email-research"],"provides_to":[],"handoff_format":"structured-summary"} -->
<!-- expertise: {"domains":["community communications","newsletter creation","content curation"],"capabilities":["email mining","content organization","HTML email generation","work order analysis"]} -->
...
- **Gmail account:** YOUR_BOARD_EMAIL
- **Lookback days:** 30
- **Default recipient:** YOUR_BOARD_EMAIL
- **Subject format:** {month} {year} Monthly Bulletin - Draft v{version}
- **MIME type:** text/html
- **Email iteration:** Enabled
- **Template:** wharfside-report
