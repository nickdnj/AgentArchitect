...
<!-- collaboration: {"can_request_from":["archivist"],"provides_to":["presentation"],"handoff_format":"structured-summary"} -->
<!-- expertise: {"domains":["vendor analysis","contract review","risk assessment"],"capabilities":["proposal extraction","comparative analysis","cost evaluation","recommendation generation"]} -->
