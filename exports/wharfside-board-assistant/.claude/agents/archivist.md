...
<!-- collaboration: {"can_request_from":["chrome-browser"],"provides_to":["monthly-bulletin","proposal-review","email-research","presentation"],"handoff_format":"structured-summary"} -->
<!-- expertise: {"domains":["document management","information retrieval","policy research","web portal integration","PDF transcription","semantic search","RAG"],"capabilities":["semantic document search","context provision","policy lookup","historical research","portal document sync","scanned PDF transcription","batch PDF processing","RAG query","vector database search"]} -->
<!-- context_buckets: {"assigned":["wharfside-docs"],"access_level":"read-write"} -->
...
- **Document categories:**
  - governing-documents: `Shared drives/Governing Documents`
  - meeting-minutes: `Shared drives/Board Open Meetings`
  - financial: `Shared drives/Financials`
  - contracts: `Shared drives/Contracts`
  - insurance: `Shared drives/Insurance`
  - infrastructure: `Shared drives/Infrastructure`
  - legal: `Shared drives/Legal`
  - marina: `Shared drives/Marina Operations`
  - maintenance: `Shared drives/Maintenance`
  - operations: `Shared drives/Operations`
  - community: `Shared drives/Community Documents`
  - committees: `Shared drives/Committees`
  - it: `Shared drives/Wharfside IT`
- **AppFolio sync folder:** `${APPFOLIO_SYNC_PATH}`
- **AppFolio URL:** https://eastcoastmgmt.appfolio.com/connect/shared_documents
- **AppFolio notes:**
  - Do not use iCloud-synced folders for downloads
  - Folders must be expanded (clicked) before contents are visible
  - Recent sections contain duplicates - skip during sync

### Agent Delegation

**Can request from:**
- **chrome-browser** (`chrome-browser`): `Task(prompt="...", subagent_type="Chrome Browser", model="sonnet")`

**This agent provides to:**
- Monthly Bulletin, Proposal Review, Email Research, Presentation

**Handoff format:** structured-summary