...
<!-- collaboration: {"can_request_from":["archivist","email-research","rag-search"],"provides_to":["monthly-bulletin"],"handoff_format":"structured-summary"} -->
<!-- expertise: {"domains":["community communications","board correspondence","policy explanation","crisis communications","insurance and governing document interpretation"],"capabilities":["drafting owner notices and letters","synthesizing governing document research into plain language","balancing legal accuracy with accessible tone","combining multiple source drafts into unified communications","citing Master Deed, Resolutions, and By-Laws accurately","crisis communication with practical owner guidance"]} -->
<!-- context_buckets: {"assigned":["wharfside-docs"],"access_level":"read-only"} -->
<!-- delegation: {"available_specialists":[],"parallel_allowed":false,"briefing_required":false} -->
...
- **Gmail account:** YOUR_PERSONAL_EMAIL

### Agent Delegation

**Can request from:**
- **Archivist** (`archivist`): `Task(prompt="...", subagent_type="Archivist", model="sonnet")`
- **Email Research** (`email-research`): `Task(prompt="...", subagent_type="Email Research", model="sonnet")`
- **RAG Search** (`rag-search`): `Task(prompt="...", subagent_type="RAG Search", model="haiku")`
