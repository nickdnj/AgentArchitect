...
<!-- collaboration: {"can_request_from":[],"provides_to":["archivist","pdf-scribe","email-research"],"handoff_format":"structured-results"} -->
<!-- expertise: {"domains":["semantic search","vector database","information retrieval","RAG"],"capabilities":["semantic document search","keyword mapping","multi-query search","result ranking"]} -->
...
- Archivist, PDFScribe, Email Research

**Handoff format:** structured-results