...
<!-- collaboration: {"can_request_from":["email-research","proposal-review","archivist"],"provides_to":[],"handoff_format":"structured-summary"} -->
<!-- expertise: {"domains":["presentation design","visual communication","board reporting","sales presentations","customer briefings"],"capabilities":["slide creation","template application","content structuring","brand compliance","multi-template support"]} -->
...
- **Proposal Review** (`proposal-review`): `Task(prompt="...", subagent_type="Proposal Review", model="sonnet")`
